...
def Boss2CharmmPRM(resid, num2typ2symb, Qs, bnd_df, ang_df, tor_df):
    ...
    prm.write('# LigParGen generated Q-PARAM file for Aqvist group (by Leela Dodda)\n')
    prm.write('\n[options]\n')
    prm.write('\n[atom_types]\n')
    for i in range(len(Qs)): 
        eps = float(Qs[i][3])
        ...
        prm.write('%4s %10.4f %10.4f %10.4f %10.4f %10.4f %10.4f\n'%(num2typ2symb[i][2],ALJ,ALJ,0.000,BLJ,BLJ,bossElement2Mass(bossPdbAtom2Element(num2typ2symb[i][0]))))
    prm.write('\n[bonds]\n')
